<div id="carouselExampleIndicators" class="carousel slide">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="assets/img/imgCarrusel1.jpg" class="d-block w-100 imgCarrusel" alt="...">
        </div>
        <div class="carousel-item">
            <img src="assets/img/imgCarrusel2.jpg" class="d-block w-100 imgCarrusel" alt="...">
        </div>
    </div>
...
<div>
    <h1>Vamos en la mitad de la aventura soldado</h1>
</div>
